...
os.chdir(my_directory) # os.chdir(r"F:\Biopython_Scripts\...")
...
#### blast_records_list = list(blast_records) #  WILL NOT END UP USING THIS LIST
...
E_VALUE_THRESH = 1.0e-50 # Request this value from user
